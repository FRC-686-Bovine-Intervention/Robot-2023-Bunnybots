...
public class ArmIOSim implements ArmIO {
    private final SingleJointedArmSim armSim = new SingleJointedArmSim(DCMotor.getFalcon500(1).withReduction(25), 4, 1, 0.876300, Arm.ArmPos.LowBack.getRads() + Units.degreesToRadians(90), Arm.ArmPos.Ground.getRads() + Units.degreesToRadians(90), true, Units.degreesToRadians(90));
